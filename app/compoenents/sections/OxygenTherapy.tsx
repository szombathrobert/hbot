...
export const OxygenTherapy = ({ city = 'Székesfehérvár' }: { city?: string }) => {
    return (
        <section aria-label="Főújdonságok és időpontfoglalás" className="relative w-full py-24 overflow-hidden flex items-center justify-center">
                ...
                >
                    <div className="max-w-3xl">
                        ...
                        <motion.div
                            ...
                            className="block lg:hidden relative w-full h-[280px] sm:h-[350px] rounded-2xl overflow-hidden mb-8 shadow-2xl"
                        >
                            <Image
                        ...
                        >
                            <Link href={"www.medicall.cc"} className="flex items-center justify-center gap-2 px-8 py-3.5 rounded-full text-lg font-bold shadow-[0_0_15px_rgba(34,211,238,0.3)] bg-cyan-500 text-[#020617] hover:bg-cyan-400 hover:shadow-[0_0_25px_rgba(34,211,238,0.5)] transition-all duration-300 ease-in-out hover:scale-105">
                                <CalendarCheck className="w-5 h-5" />
                                Időpontfoglalás
                            </Link>
                            <Link href={"#arak"} className="flex items-center justify-center gap-2 px-8 py-3.5 bg-white/10 text-white rounded-full text-lg font-bold shadow-lg backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 ease-in-out">
                                Kezelés áraink
                            </Link>
                        </motion.div>
                    </div>
