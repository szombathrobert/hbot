...
const ContactItems = [
    {
        ...
        icon: MapPin,
        href: "https://www.google.com/maps/search/?api=1&query=Endo-Kapszula+Magánorvosi+Centrum+Székesfehérvár"
    },
    {
        name: "Telefon:",
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                    ...
                    <div className="flex flex-col h-full">
                        ...
                        <motion.div
                            ...
                            className="w-full h-64 md:h-80 lg:h-full min-h-[300px] relative rounded-[2rem] overflow-hidden border border-cyan-500/30 shadow-2xl group"
                        >
                            <iframe
                            ...
                            <div className="absolute inset-0 rounded-[2rem] pointer-events-none border border-white/10 group-hover:border-cyan-400/50 transition-colors duration-500"></div>
                        </motion.div>
                    </div>
                            ...
                            >
                                <a
                                    ...
                                    className={`
                                        ...
                                        bg-gradient-to-r from-[#0f172a]/80 to-[#0f172a]/40 backdrop-blur-md
                                ...
                                >
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-xl md:text-2xl font-bold text-white group-hover:text-cyan-50 text-wrap break-words">
                                                {item.description}
                                            </span>
                                        </div>
                                    </div>
