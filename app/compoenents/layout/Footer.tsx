    ...
    <footer className="relative z-20 bg-[#020617] border-t border-white/10 pt-20 pb-10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex gap-4">
              {[
                ...
                { icon: Music2, href: "#", color: "hover:text-white" }
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.href}
          ...
          {/* 4. OSZLOP: Nyitvatartás */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h4 className="text-white font-bold uppercase tracking-widest text-sm mb-8">Nyitvatartás</h4>
        ...
        {/* ALSÓ SÁV: Copyright és Jogi linkek */}
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-center">
          ...
          <div className="flex gap-6">
            <Link href="/adatvedelem" className="text-gray-500 hover:text-gray-300 text-xs transition-colors">Adatkezelési tájékoztató</Link>
            <Link href="/aszf" className="text-gray-500 hover:text-gray-300 text-xs transition-colors">ÁSZF</Link>
          </div>
        </div>
      </div>
    </footer>
